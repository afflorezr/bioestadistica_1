...
<ul>
<li class="fragment fade-up text-left" data-fragment-index="3" style="font-size: 28px;">
Se selecciona aleatoriamente una región comercial de Colombia y se registra su <strong>tipo de clima</strong>.
</li>
<li class="fragment fade-up text-left" data-fragment-index="4" style="font-size: 28px;">
$\Omega = \{\text{Cálido}, \text{Templado}, \text{Frío}\}$
</li>
<li class="fragment fade-up text-left" data-fragment-index="5" style="font-size: 26px;">
...
<li class="fragment fade-up text-justify text-green" data-fragment-index="11" style="font-size: 26px;">
