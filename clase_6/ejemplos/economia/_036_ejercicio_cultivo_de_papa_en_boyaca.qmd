## Ejercicio: sector industrial en Boyacá
...
En un sector industrial (<em>Solanum tuberosum</em>) en clima frío de Boyacá, se seleccionan aleatoriamente <strong>dos productos</strong> y se clasifica cada uno como: <strong>Primera (P)</strong>, <strong>Segunda (S)</strong> o <strong>Descarte (D)</strong>.
</li>
...
<strong>b)</strong> Defina $A$ = "al menos un producto es Primera".
</li>
...
$A^c$ = "ningún producto es Primera":
$$A^c = \{(S,S),(S,D),(D,S),(D,D)\}$$
</li>
</ul>
</div>
