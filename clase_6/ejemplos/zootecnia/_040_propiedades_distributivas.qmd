...
Sea $\Omega = \{1,2,3,4,5,6,7,8\}$ el espacio muestral de un experimento zootécnico codificado. Defina:
</li>
...
<li class="fragment fade-up text-green" data-fragment-index="13" style="font-size: 22px;">
