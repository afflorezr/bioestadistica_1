...
<div class="block-example fragment fade-up" data-fragment-index="1">
  <div class="block-title">Ejemplo: maduración del bovinos</div>
  <div class="block-body">
<p>
En una granja de clima cálido del Tolima, se selecciona aleatoriamente un fruto de bovinos (<em>Mangifera indica</em>) y se registra su <strong>tiempo de maduración</strong> (en días) desde la floración.
</p>
  </div>
</div>
