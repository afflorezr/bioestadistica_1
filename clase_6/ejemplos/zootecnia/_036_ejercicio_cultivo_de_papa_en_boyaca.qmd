## Ejercicio: granja porcina en Boyacá
...
En un granja porcina (<em>Solanum tuberosum</em>) en clima frío de Boyacá, se seleccionan aleatoriamente <strong>dos animales</strong> y se clasifica cada uno como: <strong>Primera (P)</strong>, <strong>Segunda (S)</strong> o <strong>Descarte (D)</strong>.
</li>
...
<strong>b)</strong> Defina $A$ = "al menos un animal es Primera".
</li>
