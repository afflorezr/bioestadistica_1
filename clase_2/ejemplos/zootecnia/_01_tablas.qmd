...
<p class="fragment fade-in text-justify" data-fragment-index="2" style="font-size: 34px;">
Los siguientes datos corresponden a las pesos vivos (en kg) de 100 cerdos evaluados en un ejercicio simulado. Los pesos son datos continuos, ya que el peso se mide y puede tomar cualquier valor dentro de un intervalo: 60, 60.5, 61, 61, 61.5, 63.5, 63.5, 63.5, 64, 64, 64, 64....
</p>
...
Redondeando a un número más conveniente, se puede tomar una amplitud de 2 kg.
</li>
<li class="fragment fade-in" data-fragment-index="3"> 
Armar los intervalos.
<ul>
<li>El primer intervalo se establece desde el mínimo (60 kg) hasta el mínimo más la amplitud (62 kg), es decir, [60, 62).</li>
...
<ul>
<li>Se cuenta cuántos pesos caen dentro de cada intervalo,</li>
...
<div class="fragment fade-up info-box mt-100" style="font-size: 28px;" data-fragment-index="1">
  <ul>
    <li class="fragment fade-in" data-fragment-index="2">
      El intervalo con la mayor frecuencia absoluta es [66-68), con 40 cerdos, lo que representa el 40% de la muestra.
    </li>
    <li class="fragment fade-in" data-fragment-index="3">
      El 80% de los cerdos tiene pesos menores a 70 kg, mientras que el 20% restante tiene pesos mayores a 70 kg.
    </li>
    <li class="fragment fade-in" data-fragment-index="4">
      La distribución de los pesos muestra una mayor concentración en los intervalos [64-66), [66-68) y [68-70) indicando que la mayoría de los cerdos se encuentra en esa franja de altura, con un 72%.
    </li>
  </ul>
</div>
