...
<div class="card fragment fade-up mt-40" data-fragment-index="5">
...
<ul>
  ...
  <li class="fragment fade-up text-justify" data-fragment-index="3" style="font-size: 30px;">
    ...
    <ul>
      <li class="fragment fade-up text-justify" data-fragment-index="4" style="font-size: 30px;">Cantidades</li>
      <li class="fragment fade-up text-justify" data-fragment-index="5" style="font-size: 30px;">Proporciones</li>
      <li class="fragment fade-up text-justify" data-fragment-index="6" style="font-size: 30px;">Porcentajes</li>
    </ul>
  </li>
  <li class="fragment fade-up text-justify" data-fragment-index="7" style="font-size: 30px;">
    Se aplican a:
    <ul>
      <li class="fragment fade-up text-justify" data-fragment-index="8" style="font-size: 30px;">Variables categóricas</li>
      <li class="fragment fade-up text-justify" data-fragment-index="9" style="font-size: 30px;">Variables numéricas</li>
    </ul>
  </li>
</ul>
</div>

<div class="card fragment fade-up text-center" data-fragment-index="10">
<center>
...
<strong>Tabla de frecuencias</strong>
  ...
  <li class="fragment fade-up text-justify" data-fragment-index="3" style="font-size: 28px;">Representación tabular de los datos de una variable</li>
  <li class="fragment fade-up text-justify" data-fragment-index="4" style="font-size: 28px;">Muestra la frecuencia de cada valor o intervalo</li>
  <li class="fragment fade-up text-justify" data-fragment-index="5" style="font-size: 28px;">Organiza grandes cantidades de información</li>
  <li class="fragment fade-up text-justify" data-fragment-index="6" style="font-size: 28px;">Permite identificar patrones o tendencias</li>
  <li class="fragment fade-up text-justify" data-fragment-index="7" style="font-size: 28px;">Permite analizar el comportamiento de los datos</li>
</ul>
</div>
...
<p class="fragment fade-up text-justify" data-fragment-index="1" style="font-size: 30px;">
...
<p class="fragment fade-up text-justify" data-fragment-index="8" style="font-size: 26px;">
...
<p class="fragment fade-in text-justify" data-fragment-index="3">
...
<p class="fragment fade-in text-center" data-fragment-index="2">
$$ Amplitud: A= \frac{R}{k} $$
</p>
<ul>
<li class="fragment fade-in text-justify" data-fragment-index="3">Determinar el ancho de cada intervalo o clase,</li>
<li class="fragment fade-in text-justify" data-fragment-index="4">Definir dónde se agrupan las frecuencias en la tabla.</li>
<li class="fragment fade-in text-justify" data-fragment-index="5">Generalmente se usan intervalos de igual longitud.</li>
<li class="fragment fade-in text-justify" data-fragment-index="6">Puede redondearse para facilitar la interpretación.</li>
</ul>
</div>
