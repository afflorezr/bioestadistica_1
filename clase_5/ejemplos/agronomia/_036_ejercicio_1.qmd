...
<table class="slide-table" style="max-width: 700px; font-size: 28px;">
  ...
  <tbody>
    <tr style="background-color: #f2f2f2;">
      <td class="fragment fade-in text-left pad-12" data-fragment-index="9"><strong>Mujeres</strong></td>
    ...
    <tr style="background-color: #ffffff;">
      <td class="fragment fade-in text-left pad-12" data-fragment-index="10"><strong>Hombres</strong></td>
    ...
    <tr style="background-color: #dbe3f1; font-weight: bold; color: #1a3a8f;">
      <td class="fragment fade-in text-left pad-12" data-fragment-index="8">Total</td>
...
<p class="fragment fade-in text-justify" data-fragment-index="17" style="font-size: 28px;">
...
<li class="fragment fade-up text-justify" data-fragment-index="23" style="font-size: 28px;">
