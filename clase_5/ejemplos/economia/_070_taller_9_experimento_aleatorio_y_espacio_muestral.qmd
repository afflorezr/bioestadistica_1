...
<p class="text-justify mb-8">Se selecciona al azar una empresa de un mercado y se registra si está <strong>sana (S)</strong>, con <strong>incumplimiento (P)</strong> o con <strong>enfermedad (E)</strong>.</p>
<ol class="lh-21 pl-18">
