...
<p style="text-align: justify; margin-bottom: 8px;">Se selecciona al azar una empresa de un mercado y se registra si está <strong>sana (S)</strong>, con <strong>incumplimiento (P)</strong> o con <strong>enfermedad (E)</strong>.</p>
<ol style="line-height: 2.1; padding-left: 18px;">
