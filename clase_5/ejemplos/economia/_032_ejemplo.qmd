...
Supongamos cinco empresas donde se mide:
</p>
<ul>
...
<p class="fragment fade-in text-center" data-fragment-index="6" style="font-size: 28px;">
$$
\bar{x}=6 \qquad \bar{y}=13.6
$$
</p>
<p class="fragment fade-in text-justify" data-fragment-index="7" style="font-size: 28px;">
...
<table class="fragment fade-in slide-table" data-fragment-index="8" style="max-width: 900px; font-size: 28px;">
  ...
  <tbody>
    ...
    <tr style="background-color: #dbe3f1; font-weight: bold; color: #1a3a8f;">
      <td colspan="4" class="text-left pad-10">Suma</td>
      <td>19.0</td>
    </tr>
  </tbody>
