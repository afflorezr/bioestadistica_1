...
<p class="text-justify mb-8">Se selecciona al azar un animal de un instalación y se registra si está <strong>sana (S)</strong>, con <strong>enfermedad (P)</strong> o con <strong>enfermedad (E)</strong>.</p>
<ol class="lh-21 pl-18">
