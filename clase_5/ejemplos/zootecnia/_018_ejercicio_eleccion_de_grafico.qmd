...
<li class="fragment fade-in" data-fragment-index="4" style="font-size: 25px; text-align: justify;">Describir la relación entre dosis de suplemento (kg/animal) y ganancia de peso bovina (kg/animal) en 50 corrales.</li>
...
<li class="fragment fade-in" data-fragment-index="6" style="font-size: 25px; text-align: justify;">Comparar el porcentaje de animales enfermas entre tres tipos de dieta (arcilloso, arenoso, franco).</li>
</ol>
</div>
