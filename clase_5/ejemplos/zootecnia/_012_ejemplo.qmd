...
Evaluar si existe asociación entre el **tipo de suplementación** y la **presencia de enfermedad** en lotes fríos (cerdos) en Colombia. Se observan los siguientes datos:
</p>
<div class="twocol">
...
<table class="slide-table" style="max-width: 700px; font-size: 24px;">
  ...
  <thead>
    <tr style="background-color: #2f4aa0; color: white; text-align: center; font-size:24px">
      <th style="padding: 14px;">Suplementación</th>
      <th>Enfermedad: Sí</th>
      <th>Enfermedad: No</th>
      <th>Total</th>
    </tr>
...
$H_0$: suplementación y enfermedad son independientes  
