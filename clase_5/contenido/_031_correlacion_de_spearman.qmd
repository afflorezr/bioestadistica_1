...
<td class="text-left pad-12">Tipo de relación</td>
<td><strong>Lineal</strong></td>
<td><strong>Monótona</strong></td>
</tr>

<tr style="background-color: #ffffff;">
<td class="text-left pad-12">Usa valores originales</td>
<td>✔ Sí</td>
<td>✖ No (usa rangos)</td>
</tr>

<tr style="background-color: #f2f2f2;">
<td class="text-left pad-12">Datos ordinales</td>
<td>✖ No es el más apropiado</td>
<td>✔ Sí</td>
</tr>

<tr style="background-color: #dbe3f1; font-weight: bold;">
<td class="text-left pad-12">Sensibilidad a atípicos</td>
