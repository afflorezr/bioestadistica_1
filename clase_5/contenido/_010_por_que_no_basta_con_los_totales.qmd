...
<ul>
<li class="fragment fade-up text-justify" data-fragment-index="2" style="font-size: 29px;">
Los totales marginales muestran cuánto hay de cada categoría por separado.
</li>
<li class="fragment fade-up text-justify" data-fragment-index="3" style="font-size: 29px;">
Pero la <strong>asociación</strong> entre variables aparece en la comparación de las frecuencias conjuntas.
</li>
<li class="fragment fade-up text-justify" data-fragment-index="4" style="font-size: 29px;">
Dos tablas pueden tener los mismos marginales y, sin embargo, relaciones internas muy diferentes.
</li>
<li class="fragment fade-up text-justify" data-fragment-index="5" style="font-size: 29px;">
