...
<ul>
<li class="fragment fade-up" data-fragment-index="1" style="font-size: 32px; text-align: justify;">
...
## Datos
<h4 class="fragment fade-up" data-fragment-index="1" style="font-size: 30px; color: #3b82f6; margin-top: 30px; text-align: center;">Tabla de Parámetros</h4>
...
<div style="margin-top: 20px; font-size: 50px;" class="fragment fade-up" data-fragment-index="1">

```
                    ┌─ T⁺  P(R ∩ T⁺) = 0.20 × 0.90 = 0.18
         P(R)=0.20 ─┤
                    └─ T⁻  P(R ∩ T⁻) = 0.20 × 0.10 = 0.02
Inicio ─┤
                    ┌─ T⁺  P(Rᶜ ∩ T⁺) = 0.80 × 0.15 = 0.12
        P(Rᶜ)=0.80 ─┤
                    └─ T⁻  P(Rᶜ ∩ T⁻) = 0.80 × 0.85 = 0.68
```
...
<li class="fragment fade-up" data-fragment-index="5" style="font-size: 30px; text-align: justify; color: #059669;">
...
<li class="fragment fade-up" data-fragment-index="5" style="font-size: 30px;  margin-top: 20px; color: #052552;list-style: none; text-align: justify;">
...
## Cálculo Completo VPP y VPN

<div class="twocol">

<div class="card fragment fade-up crispdm-card--gray" data-fragment-index="1">
<p style="font-size: 30px; font-weight: bold; color: #a78bfa;">Interpretación VPP = 65.3%</p>
<ul>
<li class="fragment fade-up" data-fragment-index="2" style="font-size: 30px; text-align: justify;">
...
<div class="card fragment fade-up crispdm-card--gray" data-fragment-index="5">
<p style="font-size: 30px; font-weight: bold; color: #3b82f6;">Interpretación VPN = 94.0%</p>
<ul>
<li class="fragment fade-up" data-fragment-index="6" style="font-size: 30px; text-align: justify;">
...
## Cálculo de $P(B_i \mid A)$ y verificación
<div class="twocol">
...
## Razón de Verosimilitudes Desde Una Perspectiva Alternativa
...
<li class="fragment fade-up" data-fragment-index="4" style="font-size: 30px; text-align: justify;">
Para el ejemplo del café: LR $= 0.90 / 0.15 = 6.0$ —> la prueba es positiva lo que quiere decir que multiplica por 6 las cuotas de que la planta sea resistente.
</li>
</ul>
...
## Teorema de Bayes en Investigación: Ensayos y Experimentos de Campo
...
<ul style="margin-top: 20px;">
<li class="fragment fade-up" data-fragment-index="1" style="font-size: 30px; text-align: justify;">
<strong>Denominador:</strong> $P(T^+) = 0.88 \times 0.15 + 0.08 \times 0.85 = 0.1320 + 0.0680 = 0.20$
</li>
<li class="fragment fade-up" data-fragment-index="2" style="font-size: 30px; text-align: justify;">
<strong>VPP:</strong> $P(B|T^+) = 0.1320/0.20 = \mathbf{0.660}$ esto equivale al 66% de probabilidad de infección dado positivo.
</li>
<li class="fragment fade-up" data-fragment-index="3" style="font-size: 30px; text-align: justify;">
<strong>Para VPN:</strong> $P(T^-) = 1 - 0.20 = 0.80$. 
</li>
<li class="fragment fade-up" data-fragment-index="4" style="font-size: 30px; text-align: justify;">
<strong>Numerador:</strong> $P(T^-|B^c)\,P(B^c) = 0.92 \times 0.85 = 0.7820$
</li>

<li class="fragment fade-up" data-fragment-index="5" style="font-size: 30px; text-align: justify;">
<strong>VPN:</strong> $P(B^c|T^-) = 0.7820/0.80 = \mathbf{0.9775}$ equivale al 97.8% de confianza de que una planta negativa está sana.
</li>
<li class="fragment fade-up" data-fragment-index="6" style="font-size: 30px; text-align: justify; color: #059669;">
...
<ul style="margin-top: 15px;">
<li class="fragment fade-up" data-fragment-index="2" style="font-size: 30px; text-align: justify;list-style-type: none;">
$P(A) = 0.05\times0.40 + 0.12\times0.35 + 0.08\times0.25 = 0.020+0.042+0.020 = 0.082$
</li>
<li class="fragment fade-up" data-fragment-index="3" style="font-size: 30px; text-align: justify;list-style-type: none;">
$P(V_1|A)=0.02/0.082\approx24.4\%$  
$P(V_2|A)=0.042/0.082\approx51.2\%$  
$P(V_3|A)=0.020/0.082\approx24.4\%$
</li>
</ul>
...
<div style="margin-top: 20px; text-align: center;">
<table class="fragment fade-up" data-fragment-index="1" style="font-size: 30px; margin: auto; border-collapse: collapse; width: 82%;">
<thead>
...
<td style="padding: 7px; border: 1px solid #ccc;">$V_1$ ICA Chía</td><td style="padding: 7px; border: 1px solid #ccc;">0.40</td><td style="padding: 7px; border: 1px solid #ccc;">0.05</td><td style="padding: 7px; border: 1px solid #ccc;">0.020</td><td style="padding: 7px; border: 1px solid #ccc; font-weight: bold;">24.4%</td>
</tr>
<tr class="fragment fade-up" data-fragment-index="3" style="background-color: white;">
<td style="padding: 7px; border: 1px solid #ccc;">$V_2$ Yema de Huevo</td><td style="padding: 7px; border: 1px solid #ccc;">0.35</td><td style="padding: 7px; border: 1px solid #ccc;">0.12</td><td style="padding: 7px; border: 1px solid #ccc;">0.042</td><td style="padding: 7px; border: 1px solid #ccc; font-weight: bold; color: #dc2626;">51.2%</td>
</tr>
<tr class="fragment fade-up" data-fragment-index="4" style="background-color: #fdf4ff;">
<td style="padding: 7px; border: 1px solid #ccc;">$V_3$ Nóbsa</td><td style="padding: 7px; border: 1px solid #ccc;">0.25</td><td style="padding: 7px; border: 1px solid #ccc;">0.08</td><td style="padding: 7px; border: 1px solid #ccc;">0.020</td><td style="padding: 7px; border: 1px solid #ccc; font-weight: bold;">24.4%</td>
</tr>
...
<p class="fragment fade-up" data-fragment-index="6" style="font-size: 32px; text-align: center; color: #1e40af; margin-top: 10px;">
...
<div style="margin-top: 15px; text-align: center;">
<table class="fragment fade-up" data-fragment-index="1" style="font-size: 28px; margin: auto; border-collapse: collapse; width: 110%;">
<thead>
<tr style="background-color: #1e3a8a; color: white;">
...
<td style="padding: 10px; border: 1px solid #ccc;">Mora (Ej. 1)</td>
...
<tr class="fragment fade-up" data-fragment-index="3" style="background-color: white;">
<td style="padding: 10px; border: 1px solid #ccc;">Trigo (Ej. 2)</td>
...
<p class="fragment fade-up" data-fragment-index="5" style="font-size: 34px; text-align: center; color: #4b5563; margin-top: 15px;">
En ambos casos, la evidencia observada <strong>cambió el orden de probabilidades</strong> respecto a la situación inicial.
</p>

## Tabla Resumen de Ejercicios

<div style="margin-top: 15px; text-align: center;">
<table class="fragment fade-up" data-fragment-index="1" style="font-size: 30px; margin: auto; border-collapse: collapse; width: 100%;">
<thead>
...
## Resumen Visual 
<h4>Fórmulas y Conceptos Clave</h4>
...
<ul>
<li class="fragment fade-up" data-fragment-index="2" style="font-size: 30px;">$P(B_i)$ —> a priori</li>
<li class="fragment fade-up" data-fragment-index="3" style="font-size: 30px;">$P(A|B_i)$ —>verosimilitud</li>
<li class="fragment fade-up" data-fragment-index="4" style="font-size: 30px;">$P(B_i|A)$ —> a posteriori</li>
</ul>
</div>
...
<div class="fragment fade-in" data-fragment-index="3" style="margin-top: 20px; font-size: 34px; text-align: center;">
...
<li class="fragment fade-up" data-fragment-index="4" style="font-size: 28px;list-style-type: none;">
<strong>3 variedades</strong>: V1, V2, V3
</li>
<li class="fragment fade-up" data-fragment-index="5" style="font-size: 28px;list-style-type: none;">
...
<ul>
<li class="fragment fade-in" data-fragment-index="10" style="font-size: 28px;list-style-type: none;">
$n_1 = 3$, $n_2 = 2$, $n_3 = 4$
</li>
<li class="fragment fade-in" data-fragment-index="11" style="font-size: 28px;list-style-type: none;">
$$N = 3 \times 2 \times 4 = 24 \text{ combinaciones}$$
</li>
<li class="fragment fade-in" data-fragment-index="12" style="font-size: 28px; text-align: justify;list-style-type: none;">
...
<li class="fragment fade-in" data-fragment-index="9" style="font-size: 30px; text-align: justify;list-style-type: none;">
...
<div class="card fragment fade-up crispdm-card--gray" data-fragment-index="1">
<ul>
<li class="fragment fade-up" data-fragment-index="2" style="font-size: 25px;list-style-type: none;text-align: justify;">
<strong>Propiedad 1: </strong>
Hay una sola forma de escoger 0 elementos de un conjunto.  
También hay una sola forma de escoger todos los elementos.  
$\displaystyle\binom{n}{0} = 1$ y $\displaystyle\binom{n}{n} = 1$
</li>
<li class="fragment fade-up" data-fragment-index="3" style="font-size: 25px;list-style-type: none; text-align: justify;">
...
<li class="fragment fade-up" data-fragment-index="6" style="font-size: 25px;list-style-type: none;text-align: justify;">
...
<h4 class="fragment fade-in" data-fragment-index="7" style="font-size: 26px;">Identidad de Pascal</h4>
<li class="fragment fade-in" data-fragment-index="8" style="font-size: 25px; text-align: justify;list-style-type: none;">
El número de formas de escoger $r$ elementos de un conjunto de $n$ elementos es igual a la suma de:
</li>
<p class="fragment fade-in" data-fragment-index="9" style="font-size: 25px; text-align: center;">
$$\binom{n}{r} = \binom{n-1}{r-1} + \binom{n-1}{r}$$
</p>
<p class="fragment fade-in" data-fragment-index="10" style="font-size: 25px; text-align: justify;">
...
<ul>
<li class="fragment fade-in" data-fragment-index="6" style="font-size: 30px; text-align: justify;list-style-type: none;">
De un lote de 10 plantas de café (7 sanas, 3 con plaga) al seleccionar 3 al azar. ¿Cuál es la probabilidad de que las 3 sean sanas?
</li>
<li class="fragment fade-in" data-fragment-index="7" style="font-size: 30px;list-style-type: none;text-align: justify;">
...
<li class="fragment fade-in" data-fragment-index="8" style="font-size: 25px;list-style-type: none;text-align: justify;">
...
## Resumen: propiedades de probabilidad y reglas de conteo
<div class=twocol>
<ul>
<h4 style="color: blue; font-size: 28px; margin-bottom: 8px; padding: 8px;">Propiedades de la probabilidad</h4>
...
<ul>
<h4 style="color: #223392; font-size: 26px; margin-bottom: 8px; padding: 8px;">Reglas de conteo</h4>
<li class="fragment fade-up" style="background: #a78bfa; color: white; font-size: 26px; margin-bottom: 8px; padding: 8px;">
<strong>Principio multiplicativo:</strong> $N = n_1 \times n_2 \times \cdots \times n_k$
</li>
<li class="fragment fade-up" style="background: #3b82f6; color: white; font-size: 26px; margin-bottom: 8px; padding: 8px;">
<strong>Permutaciones (todo):</strong> $P_n = n!$ el orden importa
</li>
<li class="fragment fade-up" style="background: #59A14F; color: white; font-size: 26px; margin-bottom: 8px; padding: 8px;">
...
<strong>Combinaciones:</strong> $\binom{n}{r} = \frac{n!}{r!(n-r)!}$ el orden no importa
</li>
</ul>
</div>
...
<table class="fragment fade-in" data-fragment-index="1" style="font-size: 30px; width: 105%; border-collapse: collapse;">
...
## Ejercicios para escoger en clase {.center .middle}
...
## Ejemplo: probabilidad clásica con combinaciones 
